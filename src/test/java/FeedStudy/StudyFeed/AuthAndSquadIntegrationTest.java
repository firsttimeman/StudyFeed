...
//        squadmember.setMembershipStatus(AttendanceStatus.REJECTED);
...
//        kicked.setMembershipStatus(AttendanceStatus.KICKED_OUT);
...
//                .map(SquadMember::getMembershipStatus)
//                .findAny().orElseThrow();
//
...
//                .findAny().orElseThrow();
//
//        assertThat(member.getMembershipStatus()).isEqualTo(AttendanceStatus.KICKED_OUT);
//    }
//
//    @Test
...
//        sm.setUser(user);
//        sm.setSquad(squad);
//        sm.setMembershipStatus(AttendanceStatus.JOINED);
//
...
//        squadMember.setMembershipStatus(AttendanceStatus.PENDING);
